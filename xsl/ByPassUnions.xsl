...
<xsl:template name="pasteobj">
	...
	<xsl:variable name="twoname">UNION_<xsl:value-of select="substring-before($targets,';')"/></xsl:variable>
	<xsl:choose>
